...
You can limit the number of rows collected to client side via {{< pythondoc file="reference/pyflink.table/api/pyflink.table.Table.limit.html#pyflink.table.Table.limit" name="Table.limit">}}
